    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
          <a href="#features" className="hover:text-brand-600 transition-colors">Características</a>
          <a href="#testimonials" className="hover:text-brand-600 transition-colors">Testimonios</a>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            href="#"
            className="bg-brand-600 text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-brand-700 transition-colors"
          >
            Empezar gratis
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden border-t border-gray-100 bg-white px-6 py-4 flex flex-col gap-4 text-sm font-medium text-gray-700">
          ...
          <a href="#" className="text-brand-600 font-semibold">Empezar gratis →</a>
        </div>
      )}
    </header>
  );
